...
global" section. The reconciled technical context is indexed in
`Axiom.Spec/context/TECHNICAL_CONTEXT.md` and its affected architecture,
operations, integrations, and reference documents.
...
reading requirement. This roadmap file is archived with the other increment
records and remains the master index and entry point into that history.
