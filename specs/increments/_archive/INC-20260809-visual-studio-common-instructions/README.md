...
La consolidacion fue aplicada por el orquestador en `Axiom.Spec/specs/00..08`
y `Axiom.Spec/context/**`; este incremento conserva aqui la evidencia de su
...
incremento en la validacion dirigida. El incremento queda `closed` tras la
integracion canonica y el archivado fisico.
