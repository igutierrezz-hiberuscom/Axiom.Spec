...
- **Targets activos**: se mantienen 8 (`opencode`, `claude-code`, `github-copilot`, `vscode`, `cursor`, `antigravity`, `visual-studio-2026` y `codex`). `copilot-vscode` es solo alias legacy de `github-copilot` y LiteLLM fue retirado.
